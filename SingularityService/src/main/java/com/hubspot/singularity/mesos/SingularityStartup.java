...
class SingularityStartup {
  ...
  @Inject
  SingularityStartup(MesosClient mesosClient, Transcoder<SingularityTask> taskTranscoder, SingularityHealthchecker healthchecker, SingularityNewTaskChecker newTaskChecker,
